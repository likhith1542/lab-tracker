import { FlaskConical, LayoutDashboard, BarChart2, Settings } from 'lucide-react';

const tabs = [
  { id: 'dashboard', icon: LayoutDashboard, label: 'Lab' },
          ...
          return (
            ...
            >
              ...
              <Icon
                ...
                style={{ color: isActive ? 'var(--accent-cyan)' : 'var(--text-muted)', transition: 'color 0.2s' }}
              />
              <span
                className="text-[10px] font-semibold tracking-wide"
                style={{ color: isActive ? 'var(--accent-cyan)' : 'var(--text-muted)', fontFamily: 'DM Mono' }}
              >
                {label}
              </span>
              {isActive && (
